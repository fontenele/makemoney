...
M7.59 purely derives exact displayed bid/ask quote notionals and a normalized level-one imbalance rate, with explicit unavailability when both displayed quantities are zero. It adds no durable composition or API change.
