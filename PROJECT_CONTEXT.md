...
- M6 is closed. M7.1–M7.7 load, persist, conservatively compare, periodically refresh, durably classify, and expose bounded time-filtered reads of provider-neutral public Binance Spot/USDT symbol observations.
