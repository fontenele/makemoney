...
- M6 is closed. M7.1–M7.17 load, persist, conservatively compare, periodically refresh, durably classify, expose filtered detection research reads, and durably schedule, lease, and complete bounded observation checkpoints.
