...
- M6 is closed. M7.1–M7.12 load, persist, conservatively compare, periodically refresh, durably classify, expose filtered detection research reads, and define the provider-neutral detection-relative observation schedule.
