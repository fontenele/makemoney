...
M7.58 exposes the bounded durable top-of-book cohort through local read-only `GET /new-listings/top-of-book`, with optional `limit=1..100` and `provider=binance`.
