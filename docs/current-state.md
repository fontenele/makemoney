...
The following passed on 2026-09-19 after M7.28:

- `npm run build`
- `npm run lint`
- `npm run format:check`
- `npm test -- --runInBand` — 562 tests passed across 69 suites
...
M0 through M7.28 are implemented and fully verified milestone increments.
