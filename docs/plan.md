...
M7 — New Listing Scanner          IN PROGRESS (M7.1–M7.75 DONE)
...
Current task:
M7.75 is complete. Select the next bounded M7 increment; spread-evolution cohort API exposure, scoring, alerts, signals, and trading remain separate.
```
