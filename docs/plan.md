...
M7 — New Listing Scanner          IN PROGRESS (M7.1–M7.63 DONE)
...
Current task:
M7.63 is complete. Select the next bounded M7 increment; imbalance cohort HTTP exposure remains separate from scoring, alerts, signals, and trading.
```
