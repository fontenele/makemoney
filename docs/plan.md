...
M7 — New Listing Scanner          IN PROGRESS (M7.1–M7.44 DONE)
...
Current task:
M7.44 is complete. Select the next bounded M7 increment; activity HTTP exposure, order-book liquidity, scoring, alerts, signals, and trading remain separate decisions.
```
