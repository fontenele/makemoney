...
M7 — New Listing Scanner          IN PROGRESS (M7.1–M7.28 DONE)
...
Current task:
M7.28 is complete. Select the next bounded M7 increment; durable cohort loading, HTTP aggregate exposure, classification, alerts, scoring, signals, and trading remain separate decisions.
```
