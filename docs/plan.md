...
M7 — New Listing Scanner          IN PROGRESS (M7.1–M7.31 DONE)
...
Current task:
M7.31 is complete. Select the next bounded M7 increment; durable classification loading, HTTP exposure, alerts, scoring, signals, and trading remain separate decisions.
```
