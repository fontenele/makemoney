...
| milestones, next work, M1, M2, M3, M4, M5, M5.1, M5.2, M5.3, M5.4, M5.5, original plan | `roadmap.md`, `plan.md`, `../PROJECT_CONTEXT.md` | — |
...
| strategies, signals, recent signals, signal history, latest signal, signal endpoint, limit, bounded retention, moving average, crossover, short period, long period, required candles, STRATEGY_MA_SHORT_PERIOD, STRATEGY_MA_LONG_PERIOD, closed candles, candle feed, live evaluation, signal log, duplicate candle, buy signal, sell signal, hold signal | `strategies.md`, `roadmap.md`, `decisions.md`, `../README.md`, `../AGENTS.md` | `../src/modules/strategies`, `../src/config/environment.ts`, `../src/modules/market-data/application/market-candle-feed.service.ts` |
