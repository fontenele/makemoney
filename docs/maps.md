...
| milestones, next work, M1.1, M1.2, M1.3, M1.4 | `roadmap.md`, `../PROJECT_CONTEXT.md` | — |
...
| Binance, WebSocket, reconnect, backoff, public trades, mini ticker, candle, kline, OHLC, latest price, BTC/USDT | `binance-public-trades.md`, `binance-public-ticker.md`, `binance-public-candles.md`, `decisions.md`, `roadmap.md` | `../src/modules/market-data` |
