...
| milestones, next work, M1, M2, M2.1, original plan | `roadmap.md`, `plan.md`, `../PROJECT_CONTEXT.md` | — |
...
| paper wallet, virtual balance, BTC balance, USDT balance, credit, debit, insufficient funds, decimal.js | `paper-wallet.md`, `decisions.md`, `roadmap.md` | `../src/modules/paper-wallet`, `../src/config/environment.ts` |
