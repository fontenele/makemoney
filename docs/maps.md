...
| milestones, next work, M1, M2, M3, M3.1, M3.2, M3.3, original plan | `roadmap.md`, `plan.md`, `../PROJECT_CONTEXT.md` | — |
...
| paper trading, buy quote, sell quote, best bid, net proceeds, paper execution, trading executor, idempotency, execution persistence, atomic buy, ask price, taker fee, minimum notional, step size, liquidity, quote rejection | `paper-trading.md`, `roadmap.md`, `decisions.md`, `../AGENTS.md` | `../src/modules/paper-trading`, `../prisma/schema.prisma`, `../src/modules/market-data/application/latest-top-of-book.service.ts`, `../src/modules/market-data/application/latest-pair-metadata.service.ts` |
| sells, positions, PnL, order HTTP API, history query, deeper slippage | `paper-trading.md`, `roadmap.md`, `../AGENTS.md` | Not implemented; later M3 increments |
