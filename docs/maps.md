...
| milestones, next work, M1, M2, M3, M4, M5, M6, M6.1, M6.2, M6.3, original plan | `roadmap.md`, `plan.md`, `../PROJECT_CONTEXT.md` | — |
...
| backtest, replay, historical candles, HistoricalCandle, OHLCV, OHLC coherence, historical candle provider, Binance klines, REST klines, deterministic replay, no lookahead, signal timeline, open candle filtering, historical range, historical limit, next candle open | `backtesting.md`, `roadmap.md`, `decisions.md`, `../AGENTS.md` | `../src/modules/backtesting` |
