...
| milestones, next work, M1.1, M1.2, M1.3, M1.4, M1.5, M1.6 | `roadmap.md`, `../PROJECT_CONTEXT.md` | — |
...
| Binance, WebSocket, reconnect, backoff, public trades, mini ticker, candle, kline, OHLC, volume, trade count, book ticker, top of book, bid, ask, latest price, BTC/USDT | `binance-public-trades.md`, `binance-public-ticker.md`, `binance-public-candles.md`, `binance-public-top-of-book.md`, `decisions.md`, `roadmap.md` | `../src/modules/market-data` |
