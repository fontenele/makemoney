...
| milestones, next work, M1, M2, M3, M4, M5, M5.1, M5.2, original plan | `roadmap.md`, `plan.md`, `../PROJECT_CONTEXT.md` | — |
...
| strategies, signals, moving average, crossover, closed candles, candle feed, live evaluation, signal log, duplicate candle, buy signal, sell signal, hold signal | `strategies.md`, `roadmap.md`, `decisions.md`, `../AGENTS.md` | `../src/modules/strategies`, `../src/modules/market-data/application/market-candle-feed.service.ts` |
