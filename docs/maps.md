...
| milestones, next work, M1, M2, M3, M4, M5, M6, M6.1, original plan | `roadmap.md`, `plan.md`, `../PROJECT_CONTEXT.md` | — |
...
| backtest, replay, historical strategy evaluation, deterministic replay, no lookahead, signal timeline | `backtesting.md`, `roadmap.md`, `decisions.md`, `../AGENTS.md` | `../src/modules/backtesting` |
