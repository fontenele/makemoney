...
describe('Application (e2e)', () => {
  ...
  it('/new-listings/top-of-book (GET) validates bounded cohort input', async () => {
    const server = app.getHttpServer() as Parameters<typeof request>[0];
    await request(server)
      .get('/new-listings/top-of-book?limit=101')
      .expect(400);
  });

  it('/new-listings/top-of-book/imbalance (GET) validates bounded cohort input', async () => {
    const server = app.getHttpServer() as Parameters<typeof request>[0];
    await request(server)
      .get('/new-listings/top-of-book/imbalance?limit=101')
      .expect(400);
  });

  it('/new-listings/price-path (GET) validates bounded cohort input', async () => {
    const server = app.getHttpServer() as Parameters<typeof request>[0];
  ...
  it('/new-listings/top-of-book/imbalance/evolution (GET) validates bounded cohort input', async () => {
    const server = app.getHttpServer() as Parameters<typeof request>[0];
    await request(server)
      .get('/new-listings/top-of-book/imbalance/evolution?limit=101')
      .expect(400);
  });
  ...
  it('/new-listings/top-of-book/spread/classification (GET) requires a threshold', async () => {
    const server = app.getHttpServer() as Parameters<typeof request>[0];
    await request(server)
      .get('/new-listings/top-of-book/spread/classification')
      .expect(400);
  });

  it('/new-listings/top-of-book/spread/classification/magnitudes (GET) requires a threshold', async () => {
    const server = app.getHttpServer() as Parameters<typeof request>[0];
    await request(server)
      .get('/new-listings/top-of-book/spread/classification/magnitudes')
      .expect(400);
  });

  it('/new-listings/top-of-book/spread/classification/timing (GET) requires a threshold', async () => {
    const server = app.getHttpServer() as Parameters<typeof request>[0];
    await request(server)
      .get('/new-listings/top-of-book/spread/classification/timing')
      .expect(400);
  });
  ...
  it('/new-listings/:provider/:symbol/top-of-book/imbalance validates identity', async () => {
    const server = app.getHttpServer() as Parameters<typeof request>[0];
    await request(server)
      .get('/new-listings/other/NEWUSDT/top-of-book/imbalance')
      .expect(400);
  });
  ...
  it('/new-listings/:provider/:symbol/top-of-book/imbalance/evolution validates identity', async () => {
    const server = app.getHttpServer() as Parameters<typeof request>[0];
    await request(server)
      .get('/new-listings/other/NEWUSDT/top-of-book/imbalance/evolution')
      .expect(400);
  });
  ...
  it('/new-listings/:provider/:symbol/top-of-book/spread/classification requires a threshold', async () => {
    const server = app.getHttpServer() as Parameters<typeof request>[0];
    await request(server)
      .get('/new-listings/binance/NEWUSDT/top-of-book/spread/classification')
      .expect(400);
  });
  ...
  it('/new-listings/:provider/:symbol/price-path validates identity', async () => {
    const server = app.getHttpServer() as Parameters<typeof request>[0];
    await request(server)
      .get('/new-listings/binance/newusdt/price-path')
      .expect(400);
  });

  it('/new-listings/:provider/:symbol/variability validates identity', async () => {
    const server = app.getHttpServer() as Parameters<typeof request>[0];
    await request(server)
      .get('/new-listings/binance/newusdt/variability')
      .expect(400);
  });
