...
Local, personal platform for crypto market research, realistic paper trading, and strategy validation. M0 through M5 and M6.1–M6.15 are complete. Market feeds and bounded historical candles are public and unauthenticated; historical capital, fills, equity, statistics, and balances are fictional, with no exchange-account or real-fund access.
