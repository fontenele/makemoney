...
| `GET` | `/backtesting/runs` | Recent immutable fictional simulation snapshots, newest first | Local, read-only; optional `limit=1..100`, default `50`; returns `400` for an invalid limit and `503` when unavailable |
