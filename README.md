...
Local, personal platform for crypto market research, realistic paper trading, and strategy validation. M0 through M5 and M6.1–M6.8 are complete. Market feeds and bounded historical candles are public and unauthenticated; historical fills, valuation, statistics, drawdown, and balances are fictional, with no exchange-account or real-fund access.
